...
-- MAGIC %md
-- MAGIC # DDL — Silver tables
-- COMMAND ----------

/*
===========================================
DDL Script:create a silver tables
===========================================
Script Purpose:
          This Script creates table in the silver schema dropping the existing tables
          if they already exists.
          Run this script to redefine the ddl struture of the bronze tables.
===========================================
*/
...
-- MAGIC %md
-- MAGIC ### Create a tables based on the bronze table for ERP and CRM Data sets in the SILVER schema
...
-- MAGIC %md
-- MAGIC ## By this we created a required table to store data from the **silver** systems
-- MAGIC 
